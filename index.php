...
<body>
    <div id="app">
        ...
        <div class="header">
        <nav>
            <a class="navbar-brand logo" href="/"><img src="images/Logo.svg" alt="logo" /></a>

            <!-- Collapse button -->
            <div class="navbar-toggler first-button" type="button" data-toggle="collapse" data-target="#navbarSupportedContent20" aria-controls="navbarSupportedContent20" aria-expanded="false" aria-label="Toggle navigation">
